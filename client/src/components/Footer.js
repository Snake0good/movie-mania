...
function Footer() {
  return (
    <div>
        <footer className="text-center lg:text-left bg-slate-900 text-gray-600">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                <div className="mr-12 hidden lg:block">
                <span>Get connected with me on social media:</span>
                </div>
                <div className="flex justify-center">
                <a href="https://twitter.com/jacobegood" className="mr-6 text-gray-600">
                ...
                <a href="https://www.linkedin.com/in/jacobegood/" className="mr-6 text-gray-600">
                ...
                <a href="https://github.com/Snake0good" className="text-gray-600">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                ...
                <div >
                    <div className="flex place-items-center justify-center sm:justify-start">
                        <img className='h-8' src={logo} alt='MovieMania logo' />
                ...
                <div className="hidden md:block">
                    ...
                    <p className="mb-4">
                    <a href="https://www.jacobegood.com" className="text-gray-600">My Website</a>
                    </p>
                    <p className="mb-4">
            ...
            <div className="bg-slate-800 text-center p-6 text-blue-500">
                <span>2022 @</span>
                <a className=" font-semibold" href="https://www.jacobegood.com"> jacobegood.com</a>
            </div>
        </footer>
    </div>
  )
